...
# Define project root and current directory without relying on infra
# Assuming this file is at multiagent_experiment/addition_system/models/language_models.py
PROJECT_ROOT = pathlib.Path(__file__).resolve().parent.parent.parent.parent
# Let's define current_dir for prompts to be inside the addition_system
